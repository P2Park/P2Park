...
#if defined(NDEBUG)
# error "P2Park cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "P2Park Signed Message:\n";
...
{
    int64_t nSubsidy = POS_STAKE_REWARD;
    return nSubsidy + nFees;
}
...
#ifdef ENABLE_WALLET
// p2park: attempt to generate suitable proof-of-stake
