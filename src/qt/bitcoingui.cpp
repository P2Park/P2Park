...
#ifdef Q_OS_MAC
    resize(960, 595);
    setWindowTitle(tr("P2Park - MacOS wallet"));
#elif _WIN32
    resize(900, 580);
    setWindowTitle(tr("P2Park - Windows wallet"));
#else
    resize(1000, 630);
    setWindowTitle(tr("P2Park - Linux wallet"));
#endif
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a P2Park address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/toolbar_testnet"),tr("&About P2Park"), this);
    aboutAction->setToolTip(tr("Show information about P2Park"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for P2Park"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("P2Park client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("P2Park client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to P2Park network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid P2Park address or malformed URI parameters."));
    }
